...
class APICheckoutRequest extends FormRequest
{
    ...
    public function messages(): array
    {
        return [
            ...
            'user_id.required' => "Vui lòng đăng nhập để có thể mua hàng!",
            'user_id.numeric' => "Dữ liệu người dùng lỗi!",

            'full_name.required' => "Vui lòng nhập tên người nhận!",
            'full_name.regex' => "Tên chỉ chứa ký tự hoa, thường!",
            'full_name.min' => "Tên tối thiểu :min ký tự!",
            'full_name.max' => "Tên tối đa :max ký tự!",
