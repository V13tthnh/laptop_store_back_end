    ...
    $(function () {
        ...
        if (dt_user_table.length) {
            var dt_user = dt_user_table.DataTable({
                ajax: { url: '{{route('customers.data-table')}}', method: 'get', dataType: 'json' },
                columns: [
                    {
...
<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="py-3 mb-0">
        <span class="text-muted fw-light">Trang chủ /</span><span class="fw-medium"> Danh sách khách hàng</span>
    </h4>
